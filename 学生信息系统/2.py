...
def sort():
    ...
    if asc_or_desc == '0':
        ...
        print('您的输入有误，请重新输入')
        sort()
    mode = input('请选择排序方式（1.按照英语成绩排序  2.按照Python成绩排序  3.按照Java成绩排序  0.按照总成绩排序:')
    if mode == '1':
        ...
        student_new.sort(
            key=lambda student_new: int(student_new['Java']) + int(student_new['English'] + int(student_new['Python'])),
